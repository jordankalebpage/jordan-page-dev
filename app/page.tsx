...
export default function Home() {
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
      <section className="rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-card)] p-6 sm:p-8">
        ...
        <div className="mt-6 space-y-5">
          {experience.map((role) => (
            ...
            >
              ...
              <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-6 text-[var(--text-secondary)]">
      ...
      <section id="selected-projects" className={sectionClass}>
        ...
        <div className="mt-4">
          <Link
            className="inline-flex rounded-md border border-[var(--accent-border)] px-3 py-2 text-sm font-medium text-[var(--accent)] transition-colors hover:bg-[var(--accent-hover-bg)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--focus-ring-offset)]"
            href="/projects"
          >
          ...
          {resumeProjects.map((project) => (
            ...
            >
              ...
              <a
                ...
                className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-[var(--accent)] transition-colors hover:text-[var(--accent-hover)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--focus-ring-offset)]"
                href={project.href}
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <section id="education" className={sectionClass}>
        ...
        <p className="mt-4 text-[var(--text-strong)]">
